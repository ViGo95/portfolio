    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "svelte-n1gvyz");
    			add_location(ul, file$3, 14, 4, 444);
    			attr_dev(div0, "class", "photo-socials svelte-n1gvyz");
    			add_location(div0, file$3, 12, 2, 358);
    			attr_dev(h2, "class", "hi-text svelte-n1gvyz");
    			add_location(h2, file$3, 23, 4, 1073);
    			attr_dev(p0, "class", "tittle-text svelte-n1gvyz");
    			add_location(p0, file$3, 24, 4, 1118);
    			attr_dev(p1, "class", "about-text svelte-n1gvyz");
    			add_location(p1, file$3, 25, 4, 1186);
    			attr_dev(div1, "class", "about svelte-n1gvyz");
    			add_location(div1, file$3, 22, 2, 1048);
    			attr_dev(a4, "target", "__blank");
    			attr_dev(a4, "href", "http://cutt.ly/WhatsappBarra24");
    			attr_dev(a4, "class", "button ws-button svelte-n1gvyz");
    			add_location(a4, file$3, 30, 4, 1487);
    			attr_dev(button, "class", "button mail-button svelte-n1gvyz");
    			add_location(button, file$3, 31, 4, 1591);
    			attr_dev(div2, "class", "buttons svelte-n1gvyz");
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			attr_dev(h5, "class", "svelte-1m5w0du");
    			add_location(h5, file$1, 74, 4, 1464);
    			attr_dev(div, "class", "skills-area svelte-1m5w0du");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "skills-text svelte-1m5w0du");
    			add_location(h2, file$1, 70, 2, 1384);
    			attr_dev(section, "class", "skills-section svelte-1m5w0du");
