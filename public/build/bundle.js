    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(header, file$4, 8, 0, 166);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 13, 4, 378);
    			attr_dev(a0, "target", "__blank");
    			attr_dev(a0, "href", "https://github.com/ViGo95");
    			add_location(a0, file$3, 15, 10, 445);
    			add_location(li0, file$3, 15, 6, 441);
    			attr_dev(a1, "target", "__blank");
    			attr_dev(a1, "href", "https://www.linkedin.com/in/luis-vi%C3%B1as/");
    			add_location(a1, file$3, 16, 10, 570);
    			add_location(li1, file$3, 16, 6, 566);
    			attr_dev(a2, "target", "__blank");
    			attr_dev(a2, "href", "https://twitter.com/vigo_dev");
    			add_location(a2, file$3, 17, 10, 716);
    			add_location(li2, file$3, 17, 6, 712);
    			attr_dev(a3, "target", "__blank");
    			attr_dev(a3, "href", "https://www.instagram.com/vigo.dev/");
    			add_location(a3, file$3, 18, 10, 845);
    			add_location(li3, file$3, 18, 6, 841);
    			attr_dev(ul, "class", "svelte-1rr2u62");
    			add_location(ul, file$3, 14, 4, 430);
    			attr_dev(div0, "class", "photo-socials svelte-1rr2u62");
    			add_location(div0, file$3, 12, 2, 346);
    			attr_dev(h2, "class", "hi-text svelte-1rr2u62");
    			add_location(h2, file$3, 23, 4, 1050);
    			attr_dev(p0, "class", "tittle-text svelte-1rr2u62");
    			add_location(p0, file$3, 24, 4, 1094);
    			attr_dev(p1, "class", "about-text svelte-1rr2u62");
    			add_location(p1, file$3, 25, 4, 1161);
    			attr_dev(div1, "class", "about svelte-1rr2u62");
    			add_location(div1, file$3, 22, 2, 1026);
    			attr_dev(button0, "class", "ws-button svelte-1rr2u62");
    			add_location(button0, file$3, 30, 4, 1457);
    			attr_dev(button1, "class", "mail-button svelte-1rr2u62");
    			add_location(button1, file$3, 31, 4, 1508);
    			attr_dev(div2, "class", "buttons svelte-1rr2u62");
    			add_location(div2, file$3, 29, 2, 1431);
    			add_location(section, file$3, 10, 0, 286);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			attr_dev(a, "href", "/");
    			attr_dev(a, "class", "svelte-6w7y5");
    			add_location(a, file$2, 9, 2, 126);
    			set_style(div0, "background-color", /*progressColor*/ ctx[2]);
    			set_style(div0, "width", /*progress*/ ctx[1] + "%");
    			attr_dev(div0, "class", "progress svelte-6w7y5");
    			add_location(div0, file$2, 13, 4, 232);
    			attr_dev(div1, "class", "progress-bar svelte-6w7y5");
    			add_location(div1, file$2, 12, 2, 201);
    			attr_dev(div2, "class", "skill svelte-6w7y5");
    			add_location(div2, file$2, 8, 0, 104);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$1, 74, 4, 1390);
    			attr_dev(div, "class", "skills-area svelte-174m3e");
    			add_location(div, file$1, 76, 4, 1421);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 70, 2, 1314);
    			attr_dev(section, "class", "skills-section svelte-174m3e");
    			add_location(section, file$1, 69, 0, 1279);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 9, 0, 136);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
