    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 15, 2, 496);
    			add_location(h30, file$1, 17, 2, 543);
    			attr_dev(a0, "href", "/");
    			add_location(a0, file$1, 20, 6, 677);
    			attr_dev(div0, "class", " bg-yellow-500 h-full w-2/3");
    			add_location(div0, file$1, 24, 8, 832);
    			attr_dev(div1, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div1, file$1, 23, 6, 772);
    			attr_dev(div2, "class", "flex justify-between items-center w-24");
    			add_location(div2, file$1, 19, 4, 617);
    			attr_dev(a1, "href", "/");
    			add_location(a1, file$1, 28, 6, 971);
    			attr_dev(div3, "class", " bg-yellow-500 h-full w-2/3");
    			add_location(div3, file$1, 32, 8, 1126);
    			attr_dev(div4, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div4, file$1, 31, 6, 1066);
    			attr_dev(div5, "class", "flex justify-between items-center w-24");
    			add_location(div5, file$1, 27, 4, 911);
    			attr_dev(a2, "href", "/");
    			add_location(a2, file$1, 36, 6, 1265);
    			attr_dev(div6, "class", " bg-green-500 h-full w-4/5");
    			add_location(div6, file$1, 40, 8, 1419);
    			attr_dev(div7, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div7, file$1, 39, 6, 1359);
    			attr_dev(div8, "class", "flex justify-between items-center w-24");
    			add_location(div8, file$1, 35, 4, 1205);
    			attr_dev(div9, "class", "flex justify-between mt-2 mb-5");
    			add_location(div9, file$1, 18, 2, 567);
    			add_location(h31, file$1, 45, 2, 1507);
    			attr_dev(a3, "href", "/");
    			add_location(a3, file$1, 48, 6, 1640);
    			attr_dev(div10, "class", " bg-green-500 h-full w-10/12");
    			add_location(div10, file$1, 52, 8, 1791);
    			attr_dev(div11, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div11, file$1, 51, 6, 1731);
    			attr_dev(div12, "class", "flex justify-between items-center w-24");
    			add_location(div12, file$1, 47, 4, 1580);
    			attr_dev(a4, "href", "/");
    			add_location(a4, file$1, 56, 6, 1931);
    			attr_dev(div13, "class", " bg-green-500 h-full w-9/12");
    			add_location(div13, file$1, 60, 8, 2083);
    			attr_dev(div14, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div14, file$1, 59, 6, 2023);
    			attr_dev(div15, "class", "flex justify-between items-center w-24");
    			add_location(div15, file$1, 55, 4, 1871);
    			attr_dev(div16, "class", "flex justify-between mt-2 mb-5");
    			add_location(div16, file$1, 46, 2, 1530);
    			add_location(h32, file$1, 65, 2, 2172);
    			attr_dev(a5, "href", "/");
    			add_location(a5, file$1, 68, 6, 2301);
    			attr_dev(div17, "class", " bg-green-500 h-full w-11/12");
    			add_location(div17, file$1, 72, 8, 2458);
    			attr_dev(div18, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div18, file$1, 71, 6, 2398);
    			attr_dev(div19, "class", "flex justify-between items-center w-24");
    			add_location(div19, file$1, 67, 4, 2241);
    			attr_dev(a6, "href", "/");
    			add_location(a6, file$1, 76, 6, 2598);
    			attr_dev(div20, "class", " bg-yellow-500 h-full w-2/3");
    			add_location(div20, file$1, 80, 8, 2751);
    			attr_dev(div21, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div21, file$1, 79, 6, 2691);
    			attr_dev(div22, "class", "flex justify-between items-center w-24");
    			add_location(div22, file$1, 75, 4, 2538);
    			attr_dev(div23, "class", "flex justify-between mt-2 mb-5");
    			add_location(div23, file$1, 66, 2, 2191);
    			attr_dev(section, "class", "mx-6 mt-5 text-secondary");
    			add_location(section, file$1, 14, 0, 450);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
