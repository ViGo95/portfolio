...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$4, 11, 0, 142);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(header, file$3, 9, 0, 167);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 13, 4, 410);
    			attr_dev(a0, "href", "/");
    			add_location(a0, file$2, 15, 10, 520);
    			add_location(li0, file$2, 15, 6, 516);
    			attr_dev(a1, "href", "/");
    			add_location(a1, file$2, 16, 10, 604);
    			add_location(li1, file$2, 16, 6, 600);
    			attr_dev(a2, "href", "/");
    			add_location(a2, file$2, 17, 10, 690);
    			add_location(li2, file$2, 17, 6, 686);
    			attr_dev(a3, "href", "/");
    			add_location(a3, file$2, 18, 10, 775);
    			add_location(li3, file$2, 18, 6, 771);
    			attr_dev(ul, "class", "flex flex-col justify-between h-36");
    			add_location(ul, file$2, 14, 4, 462);
    			attr_dev(div0, "class", "flex justify-between items-center mx-16 mt-10");
    			add_location(div0, file$2, 12, 2, 346);
    			attr_dev(h2, "class", "text-3xl text-dark mx-3");
    			add_location(h2, file$2, 23, 4, 933);
    			attr_dev(p0, "class", "text-sm text-dark mx-3 mt-2");
    			add_location(p0, file$2, 24, 4, 993);
    			attr_dev(p1, "class", "text-xs text-secondary mt-4");
    			add_location(p1, file$2, 25, 4, 1076);
    			attr_dev(div1, "class", "mx-7 mt-3");
    			add_location(div1, file$2, 22, 2, 905);
    			attr_dev(buttton0, "class", "w-36 h-14 pt-4 border-2 border-decorate rounded-md text-center text-decorate font-bold");
    			add_location(buttton0, file$2, 30, 4, 1412);
    			attr_dev(buttton1, "class", "w-36 h-14 pt-4 bg-decorate rounded-md text-center text-light font-bold");
    			add_location(buttton1, file$2, 31, 4, 1542);
    			attr_dev(div2, "class", "flex justify-between mx-7 mt-5");
    			add_location(div2, file$2, 29, 2, 1363);
    			add_location(section, file$2, 10, 0, 286);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div21 = element("div");
    			div20 = element("div");
    			attr_dev(h2, "class", "text-xl ml-6 mb-3");
    			add_location(h2, file$1, 15, 2, 481);
    			add_location(h30, file$1, 17, 2, 526);
    			attr_dev(a0, "href", "/");
    			add_location(a0, file$1, 20, 6, 657);
    			attr_dev(div0, "class", " bg-medium h-full w-2/3");
    			add_location(div0, file$1, 24, 8, 808);
    			attr_dev(div1, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div1, file$1, 23, 6, 749);
    			attr_dev(div2, "class", "flex justify-between items-center w-24");
    			add_location(div2, file$1, 19, 4, 598);
    			attr_dev(a1, "href", "/");
    			add_location(a1, file$1, 28, 6, 939);
    			attr_dev(div3, "class", " bg-medium h-full w-2/3");
    			add_location(div3, file$1, 32, 8, 1090);
    			attr_dev(div4, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div4, file$1, 31, 6, 1031);
    			attr_dev(div5, "class", "flex justify-between items-center w-24");
    			add_location(div5, file$1, 27, 4, 880);
    			attr_dev(a2, "href", "/");
    			add_location(a2, file$1, 36, 6, 1221);
    			attr_dev(div6, "class", " bg-good h-full w-4/5");
    			add_location(div6, file$1, 40, 8, 1371);
    			attr_dev(div7, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div7, file$1, 39, 6, 1312);
    			attr_dev(div8, "class", "flex justify-between items-center w-24");
    			add_location(div8, file$1, 35, 4, 1162);
    			attr_dev(div9, "class", "flex justify-between mt-2 mb-5");
    			add_location(div9, file$1, 18, 2, 549);
    			add_location(h31, file$1, 45, 2, 1449);
    			attr_dev(a3, "href", "/");
    			add_location(a3, file$1, 48, 6, 1579);
    			attr_dev(div10, "class", " bg-good h-full w-10/12");
    			add_location(div10, file$1, 52, 8, 1726);
    			attr_dev(div11, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div11, file$1, 51, 6, 1667);
    			attr_dev(div12, "class", "flex justify-between items-center w-24");
    			add_location(div12, file$1, 47, 4, 1520);
    			attr_dev(a4, "href", "/");
    			add_location(a4, file$1, 56, 6, 1857);
    			attr_dev(div13, "class", " bg-good h-full w-9/12");
    			add_location(div13, file$1, 60, 8, 2005);
    			attr_dev(div14, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div14, file$1, 59, 6, 1946);
    			attr_dev(div15, "class", "flex justify-between items-center w-24");
    			add_location(div15, file$1, 55, 4, 1798);
    			attr_dev(div16, "class", "flex justify-between mt-2 mb-5");
    			add_location(div16, file$1, 46, 2, 1471);
    			add_location(h32, file$1, 65, 2, 2084);
    			attr_dev(a5, "href", "/");
    			add_location(a5, file$1, 68, 6, 2210);
    			attr_dev(div17, "class", " bg-good h-full w-11/12");
    			add_location(div17, file$1, 72, 8, 2363);
    			attr_dev(div18, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div18, file$1, 71, 6, 2304);
    			attr_dev(div19, "class", "flex justify-between items-center w-24");
    			add_location(div19, file$1, 67, 4, 2151);
    			attr_dev(a6, "href", "/");
    			add_location(a6, file$1, 76, 6, 2494);
    			attr_dev(div20, "class", " bg-medium h-full w-2/3");
    			add_location(div20, file$1, 80, 8, 2643);
    			attr_dev(div21, "class", " w-16 h-2 border border-dark rounded");
    			add_location(div21, file$1, 79, 6, 2584);
    			attr_dev(div22, "class", "flex justify-between items-center w-24");
    			add_location(div22, file$1, 75, 4, 2435);
    			attr_dev(div23, "class", "flex justify-between mt-2 mb-5");
    			add_location(div23, file$1, 66, 2, 2102);
    			attr_dev(section, "class", "mx-6 mt-5 text-secondary");
    			add_location(section, file$1, 14, 0, 436);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/TailwindCSS.svelte generated by Svelte v3.38.3 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 11, 0, 186);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Hero, Skills, TailwindCss: TailwindCSS });
    	return [];
    }
